...
<header>
    ...
    <div class="px-3 py-2 border-bottom mb-0">
      <div class="container d-flex flex-wrap justify-content-center">
        ...
        <div class="text-end">
            @if (Auth::check())
                <a href="{{route('logout')}}"><button type="button" class="btn btn-light text-dark me-2">Logout</button></a>
            @else
                <a href="{{route('login')}}"><button type="button" class="btn btn-light text-dark me-2">Login</button></a>
                <a href="{{route('register')}}"><button type="button" class="btn btn-success">Sign-up</button></a>
            @endif
        </div>
      </div>
    </div>
